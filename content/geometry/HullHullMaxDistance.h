/**
 * Author: YouKn0wWho
 * Source: https://github.com/ShahjalalShohag/code-library/blob/master/Geometry/Geometry%202D.cpp#L887
 * Description: Finds the maximum distance between any two points on different convex polygons.
 * Time: O(n)
 */
