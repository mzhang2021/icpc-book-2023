/**
 * Author: YouKn0wWho
 * Source: https://github.com/ShahjalalShohag/code-library/blob/master/Geometry/Geometry%202D.cpp#L580
 * Description: Finds the point with min sum of distances from set of points.
 * Time: $O(n \log^2 MAX)$
 */
