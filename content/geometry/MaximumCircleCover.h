/**
 * Author: YouKn0wWho
 * Source: https://github.com/ShahjalalShohag/code-library/blob/master/Geometry/Geometry%202D.cpp#L1111
 * Description: Finds the circle with radius r covering the most number of points.
 * Time: $O(n^2 \log n)$
 */
