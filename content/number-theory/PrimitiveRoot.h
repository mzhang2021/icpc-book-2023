/**
 * Author: Nachia
 * Source: https://judge.yosupo.jp/submission/109014
 * Description: Finds g such that for all a not divisible by p, $g^k = a \mod p$ for some k.
 */

#include "Factor.h"

unsigned long long primitiveRoot(unsigned long long p){
